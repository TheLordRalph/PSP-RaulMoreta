...
public class Client {
    public static void main(String[] args) throws IOException {
        ...
        if (portNumber < com.raul.Server.MIN_PORT_NUMBER || portNumber > com.raul.Server.MAX_PORT_NUMBER) {
            System.err.printf("<port number> must be an integer value between %d and %d%n", com.raul.Server.MIN_PORT_NUMBER, com.raul.Server.MAX_PORT_NUMBER);
            System.exit(1);
        }
